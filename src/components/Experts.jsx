...
import Brian from "../assets/image/webp/briana.webp";
import George from "../assets/image/webp/george.webp";

const Experts = () => {
  return (
    <>
      <section className="my-lg-5 bg_imgexperts mx-2 mx-sm-4">
        <Container className=" contaner1">
          <p className=" ff_PlusJakarta fw_500 fs_4xl text-white opacity_9 py-lg-5 py-3 mb-0 text-center">
            The Experts behind the Program
          </p>
          <Row className="justify-content-center pb-lg-5 py-3">
            <Col md={5}>
              <div className="exmanborder overflow-hidden">
                <img
                  src={Brian}
                  alt="Brian A. Bakke, PhD"
                  className="w-100 bradius_12"
                />
              </div>
              <div className="d-flex justify-content-between align-items-center mt-3 mb-2 expertsname">
                <p className="ff_PlusJakarta fw_600 fs_2xl clr_lightwhite mb-0">
                  Brian A. Bakke, PhD
                </p>
                <a href="">
                  <svg
              ...
              <p className="ff_Roboto fw_400 fs_md clr_lightwhite">
                PhD Biochemistry
              </p>
            </Col>
            <Col md={5}>
